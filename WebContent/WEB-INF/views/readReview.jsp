				...
				<div class="container-fluid">
					...
					<div class="collapse navbar-collapse" id="navbarColor02">
						<ul class="navbar-nav me-auto">
							<li class="nav-item"><a class="nav-link" onclick="window.location.href='home'">Home</a></li>
							...
							<li class="nav-item"><a class="nav-link active" onclick="window.location.href='reviewBoardList'">Review</a></li>
