					...
					<div id="cardbox" class="card">
						...
						<div class="card-body col-sm-12 col-md-12">
							...
							<form>
								...
								<a href="http://localhost:8080/Project2_shopping/html/joinform_ej.html" class="btn btn-danger btn-user btn-block">회원가입</a> 
		...
		<div class="modal-dialog">
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					<p>비밀번호 찾아줄 개인정보 입력</p>
					<input type="text" placeholder="개인정보"/>
				</div>
