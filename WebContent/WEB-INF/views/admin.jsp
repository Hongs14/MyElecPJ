			...
			<div class="row">
				...
				<div id="sidebar" class="col-sm-2 col-md-2 d-none d-xl-block">
					<div class="d-flex flex-column rounded-lg" style="background-color: #F5F5F5;">
						<div class="mx-3 mt-3"><h5>관리자 님</h5></div>
						...
						<div class="mx-3 mt-3"><h6>최근 관리 내역</h6></div>
					...
					<div class="d-flex flex-column">
						<div class="d-flex flex-column my-2">
							<a class="text-left" data-toggle="collapse" href=".collapseOne" style="font-size:large ;">회원 관리</a>
							<hr/>
							<div class="d-flex flex-column">
								<div class="collapse collapseOne text-left">유저 조회</div>
								<div class="collapse collapseOne text-left">유저 삭제</div>
							</div>
						</div>

						<div class="d-flex flex-column my-2">
							<a class="text-left " data-toggle="collapse" href=".collapseOne" style="font-size: arge;">상품 관리</a>
							<hr/>
							<div class="d-flex flex-column">
								<div class="collapse collapseOne text-left">상품 추가</div>
								<div class="collapse collapseOne text-left">상품 삭제</div>
							</div>
						</div>
						
						<div class="d-flex flex-column my-2">
							<a class="text-left " data-toggle="collapse" href=".collapseOne" style="font-size: large;">고객센터 관리</a>
							<hr/>
							<div class="d-flex flex-column">
								<div class="collapse collapseOne text-left">Q & A 확인</div>
								<div class="collapse collapseOne text-left">문의사항 관리</div>
								<div class="collapse collapseOne text-left">관리자 답변 관리</div>
							</div>
						</div>
					</div>
				</div>
