			...
			<div class="container-fluid">
				...
				<div class="collapse navbar-collapse" id="navbarColor02">
					<ul class="navbar-nav me-auto">
						<li class="nav-item"><a class="nav-link active" onclick="window.location.href='ej_Homepage_design.html'">Home</a></li>
						<li class="nav-item"><a class="nav-link" onclick="window.location.href='homepage수정1.html'">Products</a></li>
						<li class="nav-item"><a class="nav-link" onclick="window.location.href='Listpage.html'">QnA</a></li>
						<li class="nav-item"><a class="nav-link" onclick="window.location.href='Listpage.html'">Review</a></li>
						<li class="nav-item"><a class="nav-link" onclick="window.location.href='회원정보.html'">MyPage</a></li>
					</ul>
				</div>
				<form class="d-flex">
