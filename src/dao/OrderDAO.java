...
public class OrderDAO {
	...
	public List<OrderDTO> selectOrderList(Pager pager, OrderDTO order, Connection conn) throws SQLException {
		...
		sqlBuilder.append("SELECT USERS_ID, ORDERS_ID, PRODUCT_NAME, ORDERS_DATE, ORDERS_STATUS, ORDERS_PRICE, ORDER_DETAIL_ITEM_COUNT, RNUM ");
		sqlBuilder.append("FROM ( ");
		sqlBuilder.append("	SELECT ORDERS.USERS_ID, ORDERS.ORDERS_ID, PRODUCT_NAME, ORDERS_DATE, ORDERS_STATUS, ORDERS_PRICE, ORDER_DETAIL_ITEM_COUNT, rownum as RNUM ");
		...
		while (rs.next()) {
			...
			orderDTO.setOrder_detail_item_count(rs.getInt("ORDER_DETAIL_ITEM_COUNT"));
			orders.add(orderDTO);
		}
